"""
Django settings for falling_leaf_dev_64134 project.
...
ROOT_URLCONF = 'falling_leaf_dev_64134.urls'
...
WSGI_APPLICATION = 'falling_leaf_dev_64134.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "falling_leaf_dev_64134 API",
    "DESCRIPTION": "API documentation for falling_leaf_dev_64134 App",
    "VERSION": "v1",
}
